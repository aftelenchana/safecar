...
$iduser= $_SESSION['id'];
 ...
 $gg = "$url2/home/pdf/consultas/generate_reporte_nombres.php?f=$f";

 $html=file_get_contents_curl("$url2/home/pdf/consultas/generate_reporte_nombres.php?f=$f");
