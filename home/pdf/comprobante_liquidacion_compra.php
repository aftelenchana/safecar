...
$ruta_liquidacion_compra = ''.$url2.'/home/facturacion/facturacionphp/comprobantes/liquidacion_compra/no_firmados/'.$iduser.'.xml';

$acceso_liquidacion_compra = simplexml_load_file($ruta_liquidacion_compra);

$codDocModificado              = $acceso_liquidacion_compra->infoTributaria->codDoc;

 //para crear el numero dl documento necesito de 4 partes
 $razonSocial                  = $acceso_liquidacion_compra->infoTributaria->razonSocial;
 $nombreComercial              = $acceso_liquidacion_compra->infoTributaria->nombreComercial;
 $ruc                          = $acceso_liquidacion_compra->infoTributaria->ruc;
 $dirMatriz                    = $acceso_liquidacion_compra->infoTributaria->dirMatriz;
  $estab                       = $acceso_liquidacion_compra->infoTributaria->estab;
  $ptoEmi                      = $acceso_liquidacion_compra->infoTributaria->ptoEmi;
  $secuencial                  = $acceso_liquidacion_compra->infoTributaria->secuencial;
  $numDocModificado            = ''.$estab.'-'.$ptoEmi.'-'.$secuencial.'';

//informacion del comprador

$obligadoContabilidad             = $acceso_liquidacion_compra->infoLiquidacionCompra->obligadoContabilidad;
$identificacionProveedor    = $acceso_liquidacion_compra->infoLiquidacionCompra->identificacionProveedor;



  $direccionProveedor             = $acceso_liquidacion_compra->infoLiquidacionCompra->direccionProveedor;



  $razonSocialProveedor                = $acceso_liquidacion_compra->infoLiquidacionCompra->razonSocialProveedor;
  $obligadoContabilidad                = $acceso_liquidacion_compra->infoLiquidacionCompra->obligadoContabilidad;
  $fechaEmision                = $acceso_liquidacion_compra->infoLiquidacionCompra->fechaEmision;
  $totalSinImpuestos                = $acceso_liquidacion_compra->infoLiquidacionCompra->totalSinImpuestos;
  $totalDescuento                = $acceso_liquidacion_compra->infoLiquidacionCompra->totalDescuento;

  $importeTotal                = $acceso_liquidacion_compra->infoLiquidacionCompra->importeTotal;


  // Acceder a los campos adicionales en infoAdicional
$infoAdicional = $acceso_liquidacion_compra->infoAdicional->campoAdicional;
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Liquidación de Compra </title>
  </head>
  <style media="screen">
  ...
  <body>
      ...
      <div class="bloque_superior_row informacion_factura">
        <div class="">
          <table>
            <tbody>
              <tr>
                <td class="td_bld">LIQUIDACIÓN DE COMPRAS DE BIENES Y PRESTACIÓN DE SERVCIOS No :<?php echo $estab ?>-<?php echo $ptoEmi ?>-<?php echo $secuencial ?></td>
              </tr>
              <tr>
    ...
    <div class="parte_inermedia">
      <table>
        <tbody>
          <tr>
            <td> <span class="td_bld" >Razon Social/Nombres y Apellidos Emisor:</span><?php echo $razonSocialProveedor ?> </td>
          </tr>
          <tr>
            <td> <span class="td_bld" >RUC/CI Emisor:</span> <?php echo $identificacionProveedor ?></td>
          </tr>
          <tr>
            <td> <span class="td_bld" >Dirección:</span> <?php echo $direccionProveedor ?></td>
          </tr>
          <tr>
          ...
          <div class="">
            <table class="parte_productos_solo_productos">
              ...
              <tbody>
               ...
               $contador_detalles = $acceso_liquidacion_compra->detalles->detalle;
               $base_tdll = 0;
               $base_array_detalle = 1;
               foreach($contador_detalles as $Item){
                 $descripcion_producto= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->descripcion;
                 $codigoPrincipal= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->codigoPrincipal;
                 $cantidad= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->cantidad;
                 $precioUnitario= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->precioUnitario;
                 $descuento= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->descuento;
                 $precioTotalSinImpuesto= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->precioTotalSinImpuesto;
                  $impuestos= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto;
                 //CODIGO PARA DETALLES
                 $codigo= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto->codigo;
                 $codigoPorcentaje= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto->codigoPorcentaje;
                 $tarifa= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto->tarifa;
                 $baseImponible= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto->baseImponible;
                 $valor= $acceso_liquidacion_compra->detalles->detalle[$base_tdll]->impuestos->impuesto->valor;
...
<br><br><br><br>
    ...
    <div class="parte_inferior_informacion">
        ...
        <div class="informacion_ghd">
          <table class="tabla_ghdd">
            <tbody>
              ...
              <tr class="tr_info_gjd" >
                <td> <span class="td_bld" >Email Proveedor:</span> <span><?php echo $email_reeptor ?>
                  <?php
              ...
              <tr class="tr_info_gjd" >
                <td class="td_info_gjd"> <span class="td_bld" >Direccion Proveedor: </span> <span><?php echo $direccion_comprador ?></span> </td>
              </tr>
              <?php
           ...
           ?>
            ...
            <table class="formas_pago_table">
                ...
                <tbody>
                  ...
                  foreach ($acceso_liquidacion_compra->infoLiquidacionCompra->pagos->pago as $metodo) {
      ...
      foreach ($acceso_liquidacion_compra->detalles->detalle as $detalle) {
