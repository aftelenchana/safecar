...
$ruta_factura = ''.$url2.'/home/facturacion/facturacionphp/comprobantes/no_firmados/'.$iduser.''.$empresa.'payphone.xml';
...
<br><br><br><br>
    ...
    if (!empty($pagina_web)) {
     ...
     .contendedor_factura_payphone{
       text-align: center;
     }
       .contendedor_factura_payphone img{
         width: 150px;
       }
       .contendedor_factura_payphone p{
         padding: 0px;
         margin: 0px;
       }
     </style>
     <div class="contendedor_factura_payphone">
        <img src="https://guibis.com/home/img/reacciones/payphone_vertical.png" alt="">
        <p>Código Venta: <?php echo $codigo_venta ?></p>
        <p>ID Payphone: <?php echo $id_payphone ?></p>
        <p>Transacción: <?php echo $clientTransactionId ?></p>
     </div>
