...
$iduser= $_SESSION['id'];
 ...
 $gg = "$url2/home/pdf/recursos_humanos/rol_pagos.php?codigo=$codigo";



 $html=file_get_contents_curl("$url2/home/pdf/recursos_humanos/rol_pagos.php?codigo=$codigo");
