...
$numeroAutorizacion = $_GET['numeroAutorizacion'];
...
.img_logo_empresa{
  ...
  $url2 = $protocol . $domain;

             $ruta_factura = $url2.$archivo;
               ...
               $contribuyenteRimpe                      = $acceso_factura->infoTributaria->contribuyenteRimpe;
    ...
    <div class="parte_superior">
      <div class="bloque_superior_row informacion_emisor">
        <div class="img_logo_empresa">
          <img src="https://guibis.com/home/img/uploads/usuario.png" alt="">
        </div>
        <table>
          <tbody>
            <tr>
            ...
            <tr>
                    ...
                    <td><?php echo $contribuyenteRimpe ?></td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="">
          <table>
            <tbody>
              ...
              <tr>
                <td class="numero_autorzaxion"><?php echo $claveAcceso ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="clave_ed_acces"><?php echo $claveAcceso ?></td>
              </tr>
            </tbody>
          </table>
        </div>
