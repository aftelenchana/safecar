...
$query = mysqli_query($conection, "SELECT * FROM  proformas   WHERE  proformas.id_emisor  = '$iduser'
	AND proformas.empresa = '$empresa'  ORDER BY fecha DESC");
				...
				<table class="parte_productos_solo_productos">
					<thead>
						<tr>
							...
							<th class="th_productos">Imagen.</th>
						...
						<tr>
							<td class="td_productos">
								<?php if ($id_producto != 0): ?>
									<a href="https://guibis.com/producto?codigo=<?php echo $id_producto ?>"><?php echo ($id_producto); ?></a>
								<?php endif; ?>
								<?php if ($id_producto == 0): ?>
							...
							<td class="td_productos">
								...
								<?php if ($id_producto != 0): ?>
									<img src="<?php echo $data_producto['url_upload_img'] ?>/home/img/uploads/<?php echo $img_producto  ?>" width="50px;" alt="<?php echo $img_producto ?>">
								<?php endif; ?>
								<?php if ($id_producto == 0): ?>
									Ninguna
								<?php endif; ?>
							...
							<td class="td_productos"><?php echo $valor_unidad; ?></td>
							<td class="td_productos">$<?php echo $descuento; ?></td>
							<td class="td_productos">$<?php echo $iva_producto; ?></td>
							<td class="td_productos">$<?php echo $subtotal_frontend; ?></td>
						</tr>
