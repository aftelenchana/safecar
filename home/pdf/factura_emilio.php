...
$protocol = empty($_SERVER['HTTPS']) ? 'http://' : 'https://';$domain = $_SERVER['HTTP_HOST'];$url2 = $protocol . $domain;
  ...
  $ruta_factura = ''.$url2.'/home/facturacion/facturacionphp/comprobantes/no_firmados/'.$clave_acc_guardar.'.xml';
...
// Ejemplo de uso:
$F_VENCIMIENTO = $camposAdicionales['F_VENCIMIENTO'];
$celular_comprador   = $camposAdicionales['telefono'];
$email_reeptor      = $camposAdicionales['correo'];
    ...
    <div class="parte_superior">
      <div class="bloque_superior_row informacion_emisor">
        <div class="img_logo_empresa">
          <a href="https://guibis.com/code_user?code=<?php echo $id_e ?>"><img src="<?php echo $url2 ?>/home/img/uploads/<?php echo $data_empresa_cookie['img_empresa'] ?>" alt=""></a>
                            ...
                            <tbody>
                             ...
                             foreach($contador_detalles as $Item){
                               ...
                               $valor= $acceso_factura->detalles->detalle[$base_tdll]->impuestos->impuesto->valor;
                                ...
                                // Dividir la cadena en partes usando '-' como delimitador
                                  ...
                                  if ($codigoPrincipal  != '0') {
                                    ...
                                    $query_producto = mysqli_query($conection, "SELECT * FROM producto_venta WHERE idproducto = '$codigoPrincipal' ");
                               ...
                               <tr>
                                 ...
                                 <td class="td_productos"><?php echo $nombreProducto; ?></td>
...
<br><br><br><br>
    ...
    <div class="parte_inferior_informacion">
      ...
      + $totalesPorTipo['base14']+ $totalesPorTipo['base15']+ $totalesPorTipo['base5']+ $totalesPorTipo['basedif']+ $totalesPorTipo['ivadif']+ $totalesPorTipo['base13'];
        ...
        <div class="">
          <table class="tabla_resumen_fernando">
              <tbody>
                  ...
                  <tr class="tr_resumen">
                      <td class="td_bld td_resumen">Bas.Imp. 8%</td>
                  ...
                  <tr class="tr_resumen">
                      ...
                      <td class="td_resumen">$<?php echo number_format($totalesPorTipo['ivadif'], 2); ?></td>
                  </tr>
                  <tr class="tr_resumen">
