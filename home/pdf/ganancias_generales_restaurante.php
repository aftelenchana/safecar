                   ...
                   <table class="table table-bordered">
                       ...
                       <tbody>
                         ...
                         $query_lista = mysqli_query($conection,"SELECT comprobante_factura_final.fecha,comprobante_factura_final.codigo_factura,comprobante_factura_final.nombres_receptor,
                           ...
                           comprobante_factura_final.id,comprobante_factura_final.secuencia,comprobante_factura_final.fechaEmision,comprobante_factura_final.fechaAutorizacion
                            FROM `comprobante_factura_final`
                   WHERE comprobante_factura_final.id_emisor  = '$iduser' AND (comprobante_factura_final.secuencia != '00000000' || comprobante_factura_final.secuencia IS NOT NULL) AND comprobante ='factura'
                         ...
                         while ($data_lista=mysqli_fetch_array($query_lista)) {
                          ...
                          ?>
                           <tr>
                              ...
                              <td><?php echo $data_lista['secuencia']; ?> </td>
                              <td><?php echo $data_lista['estado']; ?> </td>
                                <td><?php echo $data_lista['fecha']; ?> </td>
                                <td><?php echo $data_lista['fechaEmision']; ?> </td>
                               <td><?php echo $data_lista['fechaAutorizacion']; ?> </td>
