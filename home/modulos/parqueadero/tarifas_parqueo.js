$(document).ready(function() {
    ...
    var tabla_categorias = $('#tabla_categorias').DataTable({
        "ajax": {
            "url": "/home/modulos/parqueadero/tarifas_parqueo.php",
            "type": "POST",
            "data": {
    ...
    $('#tabla_categorias').on('click', '.editar_caregoria', function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if (response != 'error') {
                    var info = JSON.parse(response);
                    $("#nombreCategoria_update").val(info.nombre_categoria);
                    $("#nombreCategoria_update").val(info.nombre_categoria);
                    $("#nombreCategoria_update").val(info.nombre_categoria);
                    $("#nombreCategoria_update").val(info.nombre_categoria);
                    $("#nombreCategoria_update").val(info.nombre_categoria);
                    ...
                    $(".cod_categoria").html(info.nombre_categoria);
                }
            },
            error: function(error){
                console.log(error);
